...
//    [self sendSubviewToBack:iv];
    ...
    //NSString *cFontName = @"RobotoBold"; // @"Univers65Bold"
    NSString *cFontName = @"Univers65Bold";
    const CGFloat cFontSizeiPhone = 83; // 83
    const CGFloat cFontSizeiPad = 200; // 200

    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
      
        self.l_S1 = [[UILabel alloc] initWithFrame:CGRectMake(17, 199, 100, 100)];
        self.l_S1.font = [UIFont fontWithName:cFontName size:cFontSizeiPhone];
        ...
        self.l_A.font = [UIFont fontWithName:cFontName size:cFontSizeiPhone];
        ...
        self.l_M.font = [UIFont fontWithName:cFontName size:cFontSizeiPhone];
        ...
        self.l_K.font = [UIFont fontWithName:cFontName size:cFontSizeiPhone];
        ...
        self.l_N.font = [UIFont fontWithName:cFontName size:cFontSizeiPhone];
        ...
        self.l_O.font = [UIFont fontWithName:cFontName size:cFontSizeiPhone];
        ...
        self.l_W.font = [UIFont fontWithName:cFontName size:cFontSizeiPhone];
        ...
        self.l_S2.font = [UIFont fontWithName:cFontName size:cFontSizeiPhone];
    ...
    else
    {
        ...
        self.l_S1.font = [UIFont fontWithName:cFontName size:cFontSizeiPad];
        ...
        self.l_A.font = [UIFont fontWithName:cFontName size:cFontSizeiPad];
        ...
        self.l_M.font = [UIFont fontWithName:cFontName size:cFontSizeiPad];
        ...
        self.l_K.font = [UIFont fontWithName:cFontName size:cFontSizeiPad];
        ...
        self.l_N.font = [UIFont fontWithName:cFontName size:cFontSizeiPad];
        ...
        self.l_O.font = [UIFont fontWithName:cFontName size:cFontSizeiPad];
        ...
        self.l_W.font = [UIFont fontWithName:cFontName size:cFontSizeiPad];
        ...
        self.l_S2.font = [UIFont fontWithName:cFontName size:cFontSizeiPad];
...
//        self.l_S1.frame = CGRectMake(self.l_S1.frame.origin.x - C_ANIMATION_LEFT_SHIFT, self.l_S1.frame.origin.y - C_ANIMATION_LEFT_UP, self.l_S1.frame.size.width, self.l_S1.frame.size.height);
//        self.l_A.frame = CGRectMake(self.l_A.frame.origin.x - C_ANIMATION_LEFT_SHIFT, self.l_A.frame.origin.y - C_ANIMATION_LEFT_UP, self.l_A.frame.size.width, self.l_A.frame.size.height);
//        self.l_M.frame = CGRectMake(self.l_M.frame.origin.x - C_ANIMATION_LEFT_SHIFT, self.l_M.frame.origin.y - C_ANIMATION_LEFT_UP, self.l_M.frame.size.width, self.l_M.frame.size.height);

//        self.l_K.frame = CGRectMake(self.l_K.frame.origin.x + C_ANIMATION_RIGHT_SHIFT, self.l_K.frame.origin.y + C_ANIMATION_RIGHT_DOWN, self.l_K.frame.size.width, self.l_K.frame.size.height);
//        self.l_N.frame = CGRectMake(self.l_N.frame.origin.x + C_ANIMATION_RIGHT_SHIFT, self.l_N.frame.origin.y + C_ANIMATION_RIGHT_DOWN, self.l_N.frame.size.width, self.l_N.frame.size.height);
//        self.l_O.frame = CGRectMake(self.l_O.frame.origin.x + C_ANIMATION_RIGHT_SHIFT, self.l_O.frame.origin.y + C_ANIMATION_RIGHT_DOWN, self.l_O.frame.size.width, self.l_O.frame.size.height);
//        self.l_W.frame = CGRectMake(self.l_W.frame.origin.x + C_ANIMATION_RIGHT_SHIFT, self.l_W.frame.origin.y + C_ANIMATION_RIGHT_DOWN, self.l_W.frame.size.width, self.l_W.frame.size.height);
//        self.l_S2.frame = CGRectMake(self.l_S2.frame.origin.x + C_ANIMATION_RIGHT_SHIFT, self.l_S2.frame.origin.y + C_ANIMATION_RIGHT_DOWN, self.l_S2.frame.size.width, self.l_S2.frame.size.height);
...
//{
//    self.fontSK = [UIFont fontWithName:cFontName size:self.animationStep++];
//    
//    CGContextRef context = UIGraphicsGetCurrentContext();
//    
//    UIColor * redColor = [UIColor colorWithRed:0.0/255.0 green:159.0/255.0 blue:227.0/255.0 alpha:1];
//    
...
//                                self.fontSK, NSFontAttributeName,
//                                style, NSParagraphStyleAttributeName,
//                                [UIColor whiteColor], NSForegroundColorAttributeName,
//                                nil];
//    
//    NSString* labelText = @"Sam";
//        
//   [labelText drawInRect:CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height) withAttributes:attributes];
//    
